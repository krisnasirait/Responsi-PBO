...
public class dataBarang extends javax.swing.JFrame {
    ...
    public void selectData() {
        String kolom[] = {"Id","Nama","Massa","Harga"};
        ...
        try {
            while(rs.next()) {
                ...
                String Massa      = rs.getString(3);
                String Harga      = rs.getString(4);
                String data[]     = {Id,Nama,Massa,Harga};
                dtm.addRow(data);
            }
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        if (baris != -1) {
            ...
            detailBarang.tNama.setText(tabel.getValueAt(baris, 1).toString());
            detailBarang.tMassa.setText(tabel.getValueAt(baris, 2).toString());
            detailBarang.tHargaSatuan.setText(tabel.getValueAt(baris, 3).toString());
